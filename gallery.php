                ...
                <div class="d-none d-lg-block col col-lg-8 col-xl-7">
                    ...
                    <div class="col-12 div-calendar mx-auto">
                        ...
                        <div
                                ...
                                data-market="FI"
                                data-currency="EU"
                                data-widget-scale="0.7"
                                data-font-colour="#5A5B95"
                                data-widget-padding="0.2rem"
                                data-button-colour="#5A5B95"
                                data-driver-age="false"
                                data-origin-name="'Helsinki'"
                                data-widget-border-radius="0.1rem"
